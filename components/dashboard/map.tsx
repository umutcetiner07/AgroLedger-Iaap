    ...
    farms.forEach(farm => {
      ...
      const popupContent = `
        <div class="text-sm">
          ...
          <div class="text-gray-700">FHS: <span class="font-bold" style="color: ${farm.color}">${farm.fhsScore}</span></div>
          <div class="text-gray-700">Area: ${farm.areaHa} ha</div>
          <div class="text-gray-500 text-xs">Last irrigation: ${new Date(farm.lastIrrigation).toLocaleDateString()}</div>
        </div>
      `
